...
from superguard.compat import maxint
from superguard.memmon import help_request, memmon_from_args, seconds_size
from superguard.tests.dummy import DummyRPCServer


class MemmonTests(unittest.TestCase):
    def _getTargetClass(self):
        from superguard.memmon import Memmon
    ...
    def test_runforever_tick_programs(self):
        ...
        self.assertEqual(mailed[1], "Subject: memmon: process baz:baz_01 restarted")
    ...
    def test_runforever_tick_groups(self):
        ...
        self.assertEqual(len(mailed), 4)
        self.assertEqual(mailed[0], "To: chrism@plope.com")
        self.assertEqual(mailed[1], "Subject: memmon: process foo:foo restarted")
        self.assertEqual(mailed[2], "")
        self.assertTrue(mailed[3].startswith("memmon.py restarted"))
    ...
    def test_stopprocess_fails_to_stop(self):
        ...
        from superguard.compat import xmlrpclib
    ...
    def test_subject_with_name(self):
        ...
        mailed = memmon.mailed.split("\n")
        self.assertEqual(
            mailed[1], "Subject: memmon [thinko]: process baz:baz_01 restarted"
        )
    ...
    def test_uptime_long_no_email(self):
        ...
        memmon.runforever(test=True)
        self.assertFalse(
            memmon.mailed, "no email should be sent because uptime is above limit"
        )
    ...
    def test_calc_rss_not_cumulative(self):
        ...
        self.assertEqual(
            None,
            rss,
            "Failure to parse an integer RSS value from the ps "
