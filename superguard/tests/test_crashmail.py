...
class CrashMailTests(unittest.TestCase):
    def _getTargetClass(self):
        from superguard.crashmail import CrashMail
    ...
    def test_runforever_expected_exit(self):
        ...
        prog.stdin.write("eventname:PROCESS_STATE_EXITED len:%s\n" % len(payload))
    ...
    def test_runforever_unexpected_exit(self):
        ...
        self.assertTrue("Process foo in group bar exited unexpectedly" in lines[6])
        import os
